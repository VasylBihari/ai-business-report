...
The goal of this repository is to demonstrate how data analysis + AI can be combined to produce clear, business-focused reports instead of raw dashboards or technical outputs.

These projects showcase a workflow used for AI-assisted business reporting and analytics.

👤 Author

Vasyl Bihari  
Data Analyst | Excel • Python • SQL | AI-Driven Business Analytics
